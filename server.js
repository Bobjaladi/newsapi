...
app.get('/api/news/:id', (req, res) => {
    ...
    const newsItem = sampleTeluguNews.find(item => item.id === newsId);
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`Total news articles: ${sampleTeluguNews.length}`);
});
